...
# load the directive's module
  ...
  it 'should hide elements if not user is logged in', inject ($compile) ->
    ...
    element = angular.element '<div is-not-authenticated style="display:none">Only for Users</div>'
  ...
  it 'should make elements visible if user is logged in', inject ($compile) ->
    ...
    element = angular.element '<div is-not-authenticated>Only for Users</div>'
    element = $compile(element) $scope
